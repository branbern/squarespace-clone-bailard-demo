    ...
    return (
        <div className='readme'>
            <div className='overlay'>
                <img src='https://images.squarespace-cdn.com/content/v1/5d3b3ed8084b6f00015405ba/1565292076495-9LH1XT20VPHIGGICBZCK/ke17ZwdGBToddI8pDm48kLkXF2pIyv_F2eUT9F60jBl7gQa3H78H3Y0txjaiv_0fDoOvxcdMmMKkDsyUqMSsMWxHk725yiiHCCLfrh8O1z4YTzHvnKhyp6Da-NYroOW3ZGjoBKy3azqku80C789l0iyqMbMesKd95J-X4EagrgU9L3Sa3U8cogeb0tjXbfawd0urKshkc5MgdBeJmALQKw/Aro+Ha_0073.jpg?format=original' />
                <div className='main-overlay'>
                    <p>Bailard Is Ideal For Your</p>
                    <h1>Business or Organization</h1>
                </div>
            </div>
          

            <div className='content'>
                <h3>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Venenatis tellus in metus vulputate eu scelerisque felis imperdiet.</h3>
